...
namespace Semester6_MainProject.MVVM.Model
{
    ...
    public partial class Phim : BaseViewModel
    {
        ...
        private string _toStringTheLoai;
        public string toStringTheLoai { get => _toStringTheLoai; set { _toStringTheLoai = value; OnPropertyChanged(); } }

        private string _toStringTacGia;
        public string toStringTacGia { get => _toStringTacGia; set { _toStringTacGia = value; OnPropertyChanged(); } }

        private string _toStringStudio;
        public string toStringStudio { get => _toStringStudio; set { _toStringStudio = value; OnPropertyChanged(); } }
        ...
        private ICollection<NguoiDung_DanhGia_Phim> _NguoiDung_DanhGia_Phim;
        public virtual ICollection<NguoiDung_DanhGia_Phim> NguoiDung_DanhGia_Phim { get => _NguoiDung_DanhGia_Phim; set { _NguoiDung_DanhGia_Phim = value; OnPropertyChanged(); } }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
